...
def load_audioset_data():
    ...
    train_data = datasets.load_dataset('agkphysics/AudioSet', split='train')
    test_data = datasets.load_dataset('agkphysics/AudioSet', split='test')

    train_data = AudioDataset(train_data)
    test_data = AudioDataset(test_data)
